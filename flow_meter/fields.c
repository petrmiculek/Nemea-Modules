...
short ur_field_sizes_static[] = {
   ...
   -1, /* DNS_NAME */
   -1, /* DNS_RDATA */
   -1, /* HTTP_REQUEST_AGENT */
   -1, /* HTTP_REQUEST_HOST */
   -1, /* HTTP_REQUEST_METHOD */
   -1, /* HTTP_REQUEST_REFERER */
   -1, /* HTTP_REQUEST_URL */
   -1, /* HTTP_RESPONSE_CONTENT_TYPE */
   -1, /* HTTPS_SNI */
   -1, /* NTP_ORIG */
   -1, /* NTP_RECV */
   -1, /* NTP_REF */
...
ur_field_type_t ur_field_types_static[] = {
   ...
   UR_TYPE_UINT16, /* HTTP_RESPONSE_STATUS_CODE */
   ...
   UR_TYPE_STRING, /* HTTP_REQUEST_AGENT */
   UR_TYPE_STRING, /* HTTP_REQUEST_HOST */
   UR_TYPE_STRING, /* HTTP_REQUEST_METHOD */
   UR_TYPE_STRING, /* HTTP_REQUEST_REFERER */
   UR_TYPE_STRING, /* HTTP_REQUEST_URL */
   UR_TYPE_STRING, /* HTTP_RESPONSE_CONTENT_TYPE */
